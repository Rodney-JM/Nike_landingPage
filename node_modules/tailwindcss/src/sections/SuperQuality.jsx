    ...
    return(
        ...
        >
            <div className=" flex flex-1 flex-col">
                <h2 className=' font-palanquin text-4xl max-sm:text-[72px] capitalize
                ...
                <p className='mt-4 lg:max-w-lg info-text'>
                    Ensuring premium cimfirt and style, our meticuslously crafted footwear is designed to elevate
                    your experience, providing you with unmatched quality, innovation, and a touch of 
                    elegance.
                </p>
                <p
